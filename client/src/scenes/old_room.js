...
class Room extends Scene{
                                ...
                                if(win){
                                    ...
                                    this.tweens.add({
                                        ...
                                        onComplete:()=>{selected_enemy.destroy();selected_enemy = null;
                                            if(imm_decke==0){   
                                                this.clearHandler(imm_deckp1,deckp1,gameManager,allowed,turn);
                                            }
                                        }
                                    });
                                    selected_card = null;
                                    ...
                                    this.tweens.add({
                                        ...
                                        onComplete:()=>{
                                            ...
                                            this.purpet(deckp1,imm_deckp1,decke,imm_decke);
                                        }
                                    });
                                    selected_enemy = null;
                                    selected_card = null;
    ...
    oscura(){
        this.r = this.add.rectangle(1280/2, 760/2, 1280, 760, 0x000000,1);
        this.tweens.add({
            targets: this.r,
            alpha: { from: 1, to: 0 },
            duration:1000,
    ...
    purpet(deckp1,imm_deckp1,decke,imm_decke){
        var imm_attack,imm_shield,log,win;
    ...
    clearHandler(imm_deckp1,deckp1,gm){
