    ...
    public sealed class ArcaneExperienceFillGraphic : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            AddRibbon(vh, rect, time * 0.45f, 0.22f, 0.035f, 0.075f,
                new Color(0.06f, 0.42f, 1f, 0.25f));
            AddRibbon(vh, rect, -time * 0.32f, 0.52f, 0.045f, 0.055f,
                new Color(0.18f, 0.62f, 1f, 0.22f));
            AddRibbon(vh, rect, time * 0.38f, 0.79f, 0.028f, 0.045f,
                new Color(0.08f, 0.34f, 1f, 0.20f));

            AddRunes(vh, rect, time);
            AddSparks(vh, rect, time);
            AddLeadingEdge(vh, rect, time);
        }
        ...
        private static void AddSparks(VertexHelper vh, Rect rect, float time)
        {
            for (int i = 0; i < SparkCount; i++)
            {
                ...
                Color spark = Color.Lerp(new Color(0.12f, 0.42f, 1f, 0.42f), new Color(0.68f, 0.86f, 1f), flicker);
                spark.a *= Mathf.SmoothStep(0f, 1f, Mathf.Sin(travel * Mathf.PI));
                AddDiamond(vh, center, size, size * Mathf.Lerp(0.45f, 1.7f, seed), spark);
            }
        }

        private static void AddRunes(VertexHelper vh, Rect rect, float time)
        {
            for (int i = 0; i < RuneCount; i++)
            {
                ...
                Color rune = new Color(0.28f, 0.62f, 1f,
        ...
        private static void AddLeadingEdge(VertexHelper vh, Rect rect, float time)
        {
            ...
            AddHorizontalQuad(vh, glow, new Color(0.04f, 0.32f, 1f, 0f),
                new Color(0.56f, 0.78f, 1f, pulse));
        }
